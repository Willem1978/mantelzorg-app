...
async function main() {
  ...
  const artikelenData = [
    ...
    { id: 'pt-6', titel: 'Zorgrooster maken met familie', beschrijving: 'Verdeel de zorgtaken over meerdere mensen. Maak een rooster zodat iedereen weet wanneer hij of zij aan de beurt is. Gebruik een gedeelde agenda.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '📋', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
    // Sub: Samen organiseren met familie/netwerk
    { id: 'pt-3', titel: 'Samenwerken met de thuiszorg', beschrijving: 'Maak goede afspraken met de thuiszorg of het verpleeghuis. Bespreek het zorgplan en maak een zorgrooster. Zo weet iedereen wie wat doet.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🤝', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 4 },
    { id: 'pt-4', titel: 'Communiceren met je naaste', beschrijving: 'Praten wordt soms moeilijker. Gebruik korte zinnen, maak oogcontact en geef de tijd om te antwoorden. Geduld en begrip maken een groot verschil.', url: 'https://www.dementie.nl/omgaan-met-dementie/communiceren-bij-dementie/tien-tips-voor-betere-communicatie', bron: 'Dementie.nl', emoji: '💬', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 5 },
    { id: 'pt-7', titel: 'Hulp vragen aan je omgeving', beschrijving: 'Veel mensen willen wel helpen, maar weten niet hoe. Durf concreet te vragen: kun je maandag koken? Zo maak je het makkelijk om ja te zeggen.', url: 'https://www.mantelzorg.nl/onderwerpen/balans/', bron: 'MantelzorgNL', emoji: '🙋', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 6 },
    ...
    { id: 'pt-9', titel: 'Dagstructuur bij dementie', beschrijving: 'Een vaste dagindeling geeft rust voor iemand met dementie. Begin vroeg met dagbesteding. Het geeft structuur en jij hebt even tijd voor jezelf.', url: 'https://www.dementie.nl/zorg-en-regelzaken/zorg-en-hulp-voor-thuis/dagbesteding-voor-je-naaste-met-dementie', bron: 'Dementie.nl', emoji: '🧠', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 9 },
    // === ZELFZORG ===
    ...
    { id: 'zz-6', titel: 'De mantelzorgtest: hoe belast ben jij?', beschrijving: 'Doe de online test en ontdek hoe het met je gaat. Je krijgt tips die passen bij jouw situatie. Het duurt maar een paar minuten.', url: 'https://www.mantelzorg.nl/onderwerpen/balans/', bron: 'MantelzorgNL', emoji: '📊', categorie: 'zelfzorg', subHoofdstuk: 'overbelasting-herkennen', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
    // Sub: Pauze en respijt organiseren
    { id: 'zz-3', titel: 'Vervangende mantelzorg: even vrij van zorgen', beschrijving: 'Geef de zorg tijdelijk aan iemand anders. Dat heet vervangende mantelzorg. Denk aan dagopvang, een logeerhuis of een vrijwilliger aan huis. Zo heb jij even rust.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🌿', categorie: 'zelfzorg', subHoofdstuk: 'pauze-en-respijt', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 4 },
    ...
    { id: 're-6', titel: 'Recht op vervangende mantelzorg', beschrijving: 'Je hebt recht op tijdelijke vervanging van de zorg. Dit kan via de Wmo, de Wlz of je zorgverzekeraar. De eigen bijdrage is maximaal 21 euro per maand.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/wie-betaalt-voor-vervangende mantelzorg/', bron: 'MantelzorgNL', emoji: '🔄', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 4 },
    ...
    { id: 're-5', titel: 'Gratis onafhankelijke clientondersteuning', beschrijving: 'Kom je er niet uit? Een clientondersteuner helpt gratis bij het organiseren van zorg en ondersteuning. Onafhankelijk en via gemeente of Wlz-route beschikbaar.', url: 'https://www.regelhulp.nl/onderwerpen/clientondersteuning', bron: 'Rijksoverheid', emoji: '🤝', categorie: 'rechten', subHoofdstuk: 'clientondersteuning', bronLabel: 'Landelijk', sorteerVolgorde: 8 },
    ...
    { id: 'fi-2', titel: 'Mantelzorgwaardering van je gemeente', beschrijving: 'Veel gemeenten geven jaarlijks een blijk van waardering aan mantelzorgers. Dit kan geld zijn, een cadeaubon of een activiteit. Vraag het aan bij je gemeente.', url: 'https://www.mantelzorg.nl/onderwerpen/geldzaken/mantelzorgwaardering', bron: 'MantelzorgNL', emoji: '🎁', categorie: 'financieel', subHoofdstuk: 'mantelzorgwaardering', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 3 },
    { id: 'fi-7', titel: 'Mantelzorgcompliment aanvragen', beschrijving: 'Het mantelzorgcompliment is een geldbedrag of cadeaubon van je gemeente. Je kunt het aanvragen via het Sociaal Wijkteam of de website van je gemeente.', url: 'https://www.mantelzorg.nl/onderwerpen/geldzaken/mantelzorgwaardering', bron: 'MantelzorgNL', emoji: '💝', categorie: 'financieel', subHoofdstuk: 'mantelzorgwaardering', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 4 },
    // Sub: Pgb aanvragen en beheer
    { id: 'fi-3', titel: 'Betaald worden via een PGB', beschrijving: 'Je naaste kan een persoonsgebonden budget (PGB) aanvragen. Daaruit kun jij als mantelzorger betaald worden. Je mag maximaal 40 uur per week declareren.', url: 'https://www.mantelzorg.nl/onderwerpen/persoonsgebonden-budget/', bron: 'MantelzorgNL', emoji: '💶', categorie: 'financieel', subHoofdstuk: 'pgb-aanvragen-beheer', bronLabel: 'Landelijk', sorteerVolgorde: 5 },
    ...
    { id: 'fi-5', titel: 'Vergoedingen hulpmiddelen: eerst aanvragen, dan kopen', beschrijving: 'Hulpmiddelen zoals een tillift, rolstoel of hoog-laag bed kunnen vergoed worden. Vraag altijd eerst vergoeding aan voordat je iets koopt.', url: 'https://www.regelhulp.nl/onderwerpen/hulpmiddelen/hulpmiddelen-thuis-wonen', bron: 'Rijksoverheid', emoji: '🦽', categorie: 'financieel', subHoofdstuk: 'vergoedingen-hulpmiddelen', bronLabel: 'Landelijk', sorteerVolgorde: 8 },
    ...
    { id: 'hp-2', titel: 'Woningaanpassingen via de Wmo', beschrijving: 'Aanpassingen in huis zoals een traplift, drempels verwijderen of een aangepaste badkamer. Vraag dit aan via je gemeente (Wmo).', url: 'https://www.regelhulp.nl/onderwerpen/hulpmiddelen/hulpmiddelen-thuis-wonen', bron: 'Rijksoverheid', emoji: '🏠', categorie: 'hulpmiddelen-producten', subHoofdstuk: 'hulpmiddelen-overzicht', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 2 },
  ...
  const gemeenteNieuwsData = [
    ...
    { id: 'gn-arnhem-2', titel: 'Vervangende mantelzorg aanvragen in Arnhem vereenvoudigd', beschrijving: 'De gemeente Arnhem heeft het aanvragen van vervangende mantelzorg makkelijker gemaakt. Via het online formulier kun je nu binnen 5 werkdagen een antwoord verwachten.', gemeente: 'Arnhem', datum: '2026-01-28', url: 'https://www.arnhem.nl', emoji: '📝' },
  ...
  const resources = [
    ...
    {
      title: 'Vervangende mantelzorg',
      description: 'Tijdelijke overname van zorgtaken zodat je even op adem kunt komen',
      content: 'Vervangende mantelzorg is een vorm van zorg waarbij je zorgtaken tijdelijk worden overgenomen. Dit geeft je de kans om even bij te komen, een dagje weg te gaan, of gewoon rust te nemen.',
      type: 'ARTICLE' as const,
      category: 'Vervangende mantelzorg',
      isNational: true,
    },
    {
