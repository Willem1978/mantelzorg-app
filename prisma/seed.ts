...
async function main() {
  ...
  const artikelenData = [
    ...
    { id: 'zz-3', titel: 'Respijtzorg: even vrij van zorgen', beschrijving: 'Geef de zorg tijdelijk aan iemand anders. Dat heet respijtzorg. Denk aan dagopvang, een logeerhuis of een vrijwilliger aan huis. Zo heb jij even rust.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🌿', categorie: 'zelfzorg', subHoofdstuk: 'pauze-en-respijt', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 4 },
    ...
    { id: 're-6', titel: 'Recht op respijtzorg', beschrijving: 'Je hebt recht op tijdelijke vervanging van de zorg. Dit kan via de Wmo, de Wlz of je zorgverzekeraar. De eigen bijdrage is maximaal 21 euro per maand.', url: 'https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/wie-betaalt-voor-respijtzorg/', bron: 'MantelzorgNL', emoji: '🔄', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 4 },
