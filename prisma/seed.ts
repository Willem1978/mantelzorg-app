...
async function main() {
  ...
  const artikelenData = [
    ...
    { id: 'pt-1', titel: 'Dagstructuur en weekplanning', beschrijving: 'Een vaste dagindeling geeft rust. Maak een weekplanning en bekijk wat je kunt uitbesteden. Zo houd je overzicht en bespaar je energie.', url: 'https://www.mantelzorg.nl/mantelzorg/balans/', bron: 'MantelzorgNL', emoji: '📅', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 1 },
    { id: 'pt-2', titel: 'Tips voor veilig medicijngebruik', beschrijving: 'Als mantelzorger help je vaak met medicijnen. Neem altijd het medicijnoverzicht mee naar de dokter. Let op veranderingen zoals sufheid of verwardheid.', url: 'https://www.zorgvoorbeter.nl/medicatieveiligheid', bron: 'Zorg voor Beter', emoji: '💊', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 2 },
    { id: 'pt-6', titel: 'Zorgrooster maken met familie', beschrijving: 'Verdeel de zorgtaken over meerdere mensen. Maak een rooster zodat iedereen weet wanneer hij of zij aan de beurt is. Gebruik een gedeelde agenda.', url: 'https://www.mantelzorg.nl/mantelzorg/zorg/', bron: 'MantelzorgNL', emoji: '📋', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
    // Sub: Samen organiseren met familie/netwerk
    { id: 'pt-3', titel: 'Samenwerken met de thuiszorg', beschrijving: 'Maak goede afspraken met de thuiszorg of het verpleeghuis. Bespreek het zorgplan en maak een zorgrooster. Zo weet iedereen wie wat doet.', url: 'https://www.mantelzorg.nl/mantelzorg/zorg/', bron: 'MantelzorgNL', emoji: '🤝', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 4 },
    { id: 'pt-4', titel: 'Communiceren met je naaste', beschrijving: 'Praten wordt soms moeilijker. Gebruik korte zinnen, maak oogcontact en geef de tijd om te antwoorden. Geduld en begrip maken een groot verschil.', url: 'https://www.dementie.nl/communicatie', bron: 'Dementie.nl', emoji: '💬', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 5 },
    { id: 'pt-7', titel: 'Hulp vragen aan je omgeving', beschrijving: 'Veel mensen willen wel helpen, maar weten niet hoe. Durf concreet te vragen: kun je maandag koken? Zo maak je het makkelijk om ja te zeggen.', url: 'https://www.mantelzorg.nl/mantelzorg/balans/', bron: 'MantelzorgNL', emoji: '🙋', categorie: 'praktische-tips', subHoofdstuk: 'samen-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 6 },
    // Sub: Veiligheid bij zware taken
    { id: 'pt-5', titel: 'Veilig tillen en verplaatsen', beschrijving: 'Leer hoe je iemand veilig helpt bij het opstaan of verplaatsen. Gebruik hulpmiddelen zoals een tillift of glijzeil. Zo voorkom je rugklachten.', url: 'https://www.hulpmiddelenwijzer.nl/', bron: 'Hulpmiddelenwijzer', emoji: '🏋️', categorie: 'praktische-tips', subHoofdstuk: 'veiligheid-zware-taken', bronLabel: 'Landelijk', sorteerVolgorde: 7 },
    ...
    { id: 'pt-9', titel: 'Dagstructuur bij dementie', beschrijving: 'Een vaste dagindeling geeft rust voor iemand met dementie. Begin vroeg met dagbesteding. Het geeft structuur en jij hebt even tijd voor jezelf.', url: 'https://www.dementie.nl/dagbesteding', bron: 'Dementie.nl', emoji: '🧠', categorie: 'praktische-tips', subHoofdstuk: 'dagelijks-organiseren', bronLabel: 'Landelijk', sorteerVolgorde: 9 },
    // === ZELFZORG ===
    // Sub: Overbelasting herkennen
    { id: 'zz-1', titel: 'Herken overbelasting op tijd', beschrijving: 'Mantelzorg kan zwaar zijn. Let op signalen zoals slecht slapen, prikkelbaar zijn of je somber voelen. Neem het serieus en zoek hulp als het te veel wordt.', url: 'https://www.mantelzorg.nl/mantelzorg/balans/overbelasting/', bron: 'MantelzorgNL', emoji: '⚠️', categorie: 'zelfzorg', subHoofdstuk: 'overbelasting-herkennen', bronLabel: 'Landelijk', sorteerVolgorde: 1 },
    { id: 'zz-2', titel: 'Grenzen stellen als mantelzorger', beschrijving: 'Je wilt graag helpen, maar je kunt niet alles doen. Gezonde grenzen zijn nodig om het vol te houden. Leer hoe je nee zegt zonder je schuldig te voelen.', url: 'https://www.mantelzorg.nl/mantelzorg/balans/', bron: 'MantelzorgNL', emoji: '🛑', categorie: 'zelfzorg', subHoofdstuk: 'overbelasting-herkennen', bronLabel: 'Landelijk', sorteerVolgorde: 2 },
    { id: 'zz-6', titel: 'De mantelzorgtest: hoe belast ben jij?', beschrijving: 'Doe de online test en ontdek hoe het met je gaat. Je krijgt tips die passen bij jouw situatie. Het duurt maar een paar minuten.', url: 'https://www.mantelzorg.nl/mantelzorg/balans/', bron: 'MantelzorgNL', emoji: '📊', categorie: 'zelfzorg', subHoofdstuk: 'overbelasting-herkennen', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
    // Sub: Pauze en respijt organiseren
    { id: 'zz-3', titel: 'Respijtzorg: even vrij van zorgen', beschrijving: 'Geef de zorg tijdelijk aan iemand anders. Dat heet respijtzorg. Denk aan dagopvang, een logeerhuis of een vrijwilliger aan huis. Zo heb jij even rust.', url: 'https://www.mantelzorg.nl/mantelzorg/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🌿', categorie: 'zelfzorg', subHoofdstuk: 'pauze-en-respijt', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 4 },
    { id: 'zz-7', titel: 'Logeeropvang en vakantiemogelijkheden', beschrijving: 'Je naaste kan tijdelijk logeren in een zorginstelling zodat jij op vakantie kunt. Vraag het aan via je gemeente of zorgkantoor. Plan het op tijd.', url: 'https://www.mantelzorg.nl/mantelzorg/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🏖️', categorie: 'zelfzorg', subHoofdstuk: 'pauze-en-respijt', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 5 },
    // Sub: Emotionele steun en praten
    { id: 'zz-4', titel: 'Werk en mantelzorg combineren', beschrijving: 'Veel mantelzorgers werken ook. Praat erover met je werkgever. Vaak is er meer mogelijk dan je denkt, zoals thuiswerken of aangepaste werktijden.', url: 'https://www.mantelzorg.nl/mantelzorg/werk/', bron: 'MantelzorgNL', emoji: '💼', categorie: 'zelfzorg', subHoofdstuk: 'emotionele-steun', bronLabel: 'Landelijk', sorteerVolgorde: 6 },
    { id: 'zz-5', titel: 'De Mantelzorglijn: praat met iemand', beschrijving: 'Heb je vragen of wil je je verhaal kwijt? Bel de Mantelzorglijn op 030 760 60 55. Je kunt ook WhatsAppen of mailen. Ze staan voor je klaar.', url: 'https://www.mantelzorg.nl/mantelzorglijn/', bron: 'MantelzorgNL', emoji: '📞', categorie: 'zelfzorg', subHoofdstuk: 'emotionele-steun', bronLabel: 'Landelijk', sorteerVolgorde: 7 },
    { id: 'zz-8', titel: 'Lotgenotencontact: praat met andere mantelzorgers', beschrijving: 'Het helpt om te praten met mensen die hetzelfde meemaken. Via MantelzorgNL of je steunpunt vind je lotgenotengroepen bij jou in de buurt.', url: 'https://www.mantelzorg.nl/mantelzorg/ondersteuning/', bron: 'MantelzorgNL', emoji: '👥', categorie: 'zelfzorg', subHoofdstuk: 'emotionele-steun', bronLabel: 'Landelijk', sorteerVolgorde: 8 },
    // === JE RECHTEN ===
    // Sub: Routekaart Wmo/Zvw/Wlz
    { id: 're-1', titel: 'De Wmo: hulp via je gemeente', beschrijving: 'Via de Wet maatschappelijke ondersteuning (Wmo) kun je hulp krijgen van je gemeente. Denk aan huishoudelijke hulp, vervoer of aanpassingen in huis.', url: 'https://www.mantelzorg.nl/mantelzorg/wetten/wmo/', bron: 'MantelzorgNL', emoji: '🏛️', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 1 },
    { id: 're-2', titel: 'Mantelzorg is altijd vrijwillig', beschrijving: 'De gemeente mag je niet verplichten om mantelzorg te geven. Je mag altijd nee zeggen. Vraag de gemeente dan om een andere oplossing te zoeken.', url: 'https://www.mantelzorg.nl/mantelzorg/wetten/', bron: 'MantelzorgNL', emoji: '✋', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 2 },
    { id: 're-4', titel: 'Recht op zorgverlof van je werk', beschrijving: 'Als werknemer heb je recht op kortdurend zorgverlof (70% loon) en langdurend zorgverlof (onbetaald). Je werkgever mag dit alleen weigeren bij ernstige bedrijfsproblemen.', url: 'https://www.rijksoverheid.nl/onderwerpen/zorgverlof', bron: 'Rijksoverheid', emoji: '📋', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
    { id: 're-6', titel: 'Recht op respijtzorg', beschrijving: 'Je hebt recht op tijdelijke vervanging van de zorg. Dit kan via de Wmo, de Wlz of je zorgverzekeraar. De eigen bijdrage is maximaal 21 euro per maand.', url: 'https://www.mantelzorg.nl/mantelzorg/vervangende-zorg/', bron: 'MantelzorgNL', emoji: '🔄', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 4 },
    { id: 're-7', titel: 'De Wlz: langdurige zorg', beschrijving: 'Bij blijvende, intensieve zorg kan je naaste in aanmerking komen voor de Wet langdurige zorg (Wlz). Het CIZ beoordeelt of iemand hiervoor in aanmerking komt.', url: 'https://www.rijksoverheid.nl/onderwerpen/verpleeghuizen-en-zorginstellingen/wet-langdurige-zorg-wlz', bron: 'Rijksoverheid', emoji: '🏥', categorie: 'rechten', subHoofdstuk: 'routekaart-wmo-zvw-wlz', bronLabel: 'Landelijk', sorteerVolgorde: 5 },
    ...
    { id: 're-8', titel: 'Bezwaar maken tegen een beslissing', beschrijving: 'Ben je het niet eens met de beslissing van je gemeente? Je kunt bezwaar maken. Dat moet binnen zes weken. Een clientondersteuner kan je hierbij helpen.', url: 'https://www.rijksoverheid.nl/onderwerpen/zorg-en-ondersteuning-thuis/vraag-en-antwoord/niet-eens-besluit-wmo', bron: 'Rijksoverheid', emoji: '📢', categorie: 'rechten', subHoofdstuk: 'gemeente-wmo-aanvragen', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 7 },
    // Sub: Gratis clientondersteuning
    { id: 're-5', titel: 'Gratis onafhankelijke clientondersteuning', beschrijving: 'Kom je er niet uit? Een clientondersteuner helpt gratis bij het organiseren van zorg en ondersteuning. Onafhankelijk en via gemeente of Wlz-route beschikbaar.', url: 'https://www.rijksoverheid.nl/onderwerpen/zorg-en-ondersteuning-thuis/clientondersteuning', bron: 'Rijksoverheid', emoji: '🤝', categorie: 'rechten', subHoofdstuk: 'clientondersteuning', bronLabel: 'Landelijk', sorteerVolgorde: 8 },
    { id: 're-9', titel: 'Regelhulp: welke zorg past bij jou?', beschrijving: 'Via Regelhulp.nl vind je snel welke hulp en ondersteuning er is voor jouw situatie. Beantwoord een paar vragen en krijg een persoonlijk advies.', url: 'https://www.regelhulp.nl/', bron: 'Rijksoverheid', emoji: '🧭', categorie: 'rechten', subHoofdstuk: 'clientondersteuning', bronLabel: 'Landelijk', sorteerVolgorde: 9 },
    // === FINANCIEEL ===
    ...
    { id: 'fi-6', titel: 'Zorgkosten aftrekken bij de belasting', beschrijving: 'Hoge zorgkosten? Die kun je soms aftrekken bij je belastingaangifte. Denk aan medicijnen, hulpmiddelen of reiskosten naar het ziekenhuis.', url: 'https://www.belastingdienst.nl/wps/wcm/connect/nl/aftrek-en-kortingen/content/aftrek-specifieke-zorgkosten', bron: 'Belastingdienst', emoji: '🧾', categorie: 'financieel', subHoofdstuk: 'eigen-bijdrage-kosten', bronLabel: 'Landelijk', sorteerVolgorde: 2 },
    // Sub: Mantelzorgwaardering
    { id: 'fi-2', titel: 'Mantelzorgwaardering van je gemeente', beschrijving: 'Veel gemeenten geven jaarlijks een blijk van waardering aan mantelzorgers. Dit kan geld zijn, een cadeaubon of een activiteit. Vraag het aan bij je gemeente.', url: 'https://www.mantelzorg.nl/mantelzorg/waardering/', bron: 'MantelzorgNL', emoji: '🎁', categorie: 'financieel', subHoofdstuk: 'mantelzorgwaardering', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 3 },
    { id: 'fi-7', titel: 'Mantelzorgcompliment aanvragen', beschrijving: 'Het mantelzorgcompliment is een geldbedrag of cadeaubon van je gemeente. Je kunt het aanvragen via het Sociaal Wijkteam of de website van je gemeente.', url: 'https://www.mantelzorg.nl/mantelzorg/waardering/', bron: 'MantelzorgNL', emoji: '💝', categorie: 'financieel', subHoofdstuk: 'mantelzorgwaardering', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 4 },
    // Sub: Pgb aanvragen en beheer
    { id: 'fi-3', titel: 'Betaald worden via een PGB', beschrijving: 'Je naaste kan een persoonsgebonden budget (PGB) aanvragen. Daaruit kun jij als mantelzorger betaald worden. Je mag maximaal 40 uur per week declareren.', url: 'https://www.mantelzorg.nl/mantelzorg/pgb/', bron: 'MantelzorgNL', emoji: '💶', categorie: 'financieel', subHoofdstuk: 'pgb-aanvragen-beheer', bronLabel: 'Landelijk', sorteerVolgorde: 5 },
    { id: 'fi-4', titel: 'Belasting en PGB-inkomen', beschrijving: 'Krijg je geld uit een PGB? Dan moet je dit opgeven bij de belastingaangifte als inkomsten uit overig werk. Let op: dit kan gevolgen hebben voor je toeslagen.', url: 'https://www.svb.nl/nl/pgb', bron: 'SVB', emoji: '📊', categorie: 'financieel', subHoofdstuk: 'pgb-aanvragen-beheer', bronLabel: 'Landelijk', sorteerVolgorde: 6 },
    { id: 'fi-8', titel: 'PGB declareren via de SVB', beschrijving: 'De Sociale Verzekeringsbank (SVB) beheert je PGB. Via het SVB-portaal declareer je uren en wordt je zorgverlener betaald. Houd je administratie bij.', url: 'https://www.svb.nl/nl/pgb', bron: 'SVB', emoji: '🏦', categorie: 'financieel', subHoofdstuk: 'pgb-aanvragen-beheer', bronLabel: 'Landelijk', sorteerVolgorde: 7 },
    // Sub: Vergoedingen hulpmiddelen
    { id: 'fi-5', titel: 'Vergoedingen hulpmiddelen: eerst aanvragen, dan kopen', beschrijving: 'Hulpmiddelen zoals een tillift, rolstoel of hoog-laag bed kunnen vergoed worden. Vraag altijd eerst vergoeding aan voordat je iets koopt.', url: 'https://www.rijksoverheid.nl/onderwerpen/zorg-en-ondersteuning-thuis/hulpmiddelen-in-en-om-het-huis', bron: 'Rijksoverheid', emoji: '🦽', categorie: 'financieel', subHoofdstuk: 'vergoedingen-hulpmiddelen', bronLabel: 'Landelijk', sorteerVolgorde: 8 },
    { id: 'fi-9', titel: 'Zorgtoeslag en huurtoeslag', beschrijving: 'Als je een laag inkomen hebt, kun je zorgtoeslag en huurtoeslag aanvragen. Mantelzorgen kan invloed hebben op je inkomen en daarmee op je toeslagen.', url: 'https://www.toeslagen.nl/', bron: 'Belastingdienst', emoji: '💳', categorie: 'financieel', subHoofdstuk: 'vergoedingen-hulpmiddelen', bronLabel: 'Landelijk', sorteerVolgorde: 9 },
    // === HULPMIDDELEN & PRODUCTEN ===
    // Sub: Hulpmiddelen overzicht
    ...
    { id: 'hp-2', titel: 'Woningaanpassingen via de Wmo', beschrijving: 'Aanpassingen in huis zoals een traplift, drempels verwijderen of een aangepaste badkamer. Vraag dit aan via je gemeente (Wmo).', url: 'https://www.rijksoverheid.nl/onderwerpen/zorg-en-ondersteuning-thuis/hulpmiddelen-in-en-om-het-huis', bron: 'Rijksoverheid', emoji: '🏠', categorie: 'hulpmiddelen-producten', subHoofdstuk: 'hulpmiddelen-overzicht', bronLabel: 'Gemeente (Wmo)', sorteerVolgorde: 2 },
    { id: 'hp-4', titel: 'Douchestoel, toiletverhoger en badlift', beschrijving: 'Kleine aanpassingen in de badkamer maken een groot verschil. Een douchestoel, toiletverhoger of badlift helpt bij de persoonlijke verzorging.', url: 'https://www.hulpmiddelenwijzer.nl/', bron: 'Vilans', emoji: '🚿', categorie: 'hulpmiddelen-producten', subHoofdstuk: 'hulpmiddelen-overzicht', bronLabel: 'Landelijk', sorteerVolgorde: 3 },
