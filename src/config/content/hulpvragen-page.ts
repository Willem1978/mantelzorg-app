...
export const hulpvragenPageContent = {
  ...
  mijnVragen: {
    ...
    status: {
      OPEN: "Open",
      REACTIES: "Reacties",
      TOEGEWEZEN: "Wacht op bevestiging",
      VOLTOOID: "Afgerond",
      GEANNULEERD: "Geannuleerd",
    } as Record<string, string>,
    statusKleur: {
      OPEN: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
      REACTIES: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300",
      TOEGEWEZEN: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300",
      VOLTOOID: "bg-gray-100 text-gray-600 dark:bg-gray-800/30 dark:text-gray-400",
      GEANNULEERD: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300",
    } as Record<string, string>,
    reactieStatus: {
      INTERESSE: "Wil helpen",
      GEACCEPTEERD: "Geaccepteerd",
      AFGEWEZEN: "Afgewezen",
    } as Record<string, string>,
    accepteer: "Accepteer",
    afwijzen: "Afwijzen",
    chatOpenen: "Chat openen",
    bezig: "Bezig...",
  },
