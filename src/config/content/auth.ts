...
export const authContent = {
  ...
  register: {
    ...
    form: {
      ...
      phoneLabel: "Je mobiele nummer (niet verplicht)",
    ...
    privacy: {
      akkoord: "Ik ga akkoord met de privacyregels (we delen je gegevens nooit met anderen)",
    ...
    footer: {
      heeftAccount: "Heb je al een account? Log in",
    },
    success: {
