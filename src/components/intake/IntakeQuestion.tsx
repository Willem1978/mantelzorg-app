      ...
      {type === "TEXT" && (
        <div className="mb-6">
          <textarea
            ...
            className="w-full px-5 py-4 border-2 border-gray-200 rounded-2xl focus:outline-none focus:border-teal-500 min-h-[150px] resize-none text-lg transition-colors"
          />
        </div>
      )}
