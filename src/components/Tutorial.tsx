  ...
  return (
    <div className="flex flex-col items-center text-center pt-8">
      ...
      <div className="ker-card p-5 text-left w-full">
        <p className="text-base leading-relaxed" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Ik ben <strong>Ger</strong>, en ik ga je stap voor stap uitleggen hoe MantelBuddy jou kan helpen.') }} />
        {content?.tip && (
...
function StapTest({ content }: { content?: TutorialStep }) {
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-6" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Met een <strong>korte test</strong> van 2 minuten kijken we hoe het met je gaat. Je krijgt een score die laat zien of je het goed volhoudt.') }} />
...
function StapHulpMantelzorger({ content }: { content?: TutorialStep }) {
  ...
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Je hoeft het niet alleen te doen. MantelBuddy zoekt hulp <strong>bij jou in de buurt</strong>.') }} />
...
function StapHulpNaaste({ content }: { content?: TutorialStep }) {
  ...
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Er is ook hulp voor de persoon waar je voor zorgt. De kleuren laten zien wat het zwaarst is.') }} />
...
function StapMantelBuddies({ content }: { content?: TutorialStep }) {
  ...
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Een <strong>MantelBuddy</strong> is een vrijwilliger bij jou in de buurt. Die helpt je graag met kleine taken.') }} />
      ...
      <p className="text-base text-muted-foreground mt-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.tip || 'Eenmalig of vaker -- jij kiest. Je vindt ze bij <strong>Hulp</strong>.') }} />
    </div>
  )
}
...
function StapInformatie({ content }: { content?: TutorialStep }) {
  ...
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Bij <strong>Informatie</strong> vind je handige artikelen en nieuws uit jouw gemeente.') }} />
...
function StapFavorieten({ content }: { content?: TutorialStep }) {
  return (
    <div className="pt-6">
      ...
      <p className="text-base leading-relaxed mb-5" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.body || 'Kom je iets tegen dat je wilt onthouden? Tik op het <strong class="text-primary">hartje ❤️</strong> om het te bewaren.') }} />
      ...
      <p className="text-base leading-relaxed" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.tip || 'Je favorieten vind je terug op een eigen pagina. Daar kun je ze ook <strong>afvinken</strong> als je ze hebt gedaan. ✅') }} />
    </div>
  )
}
...
function StapKlaar({ naam, content }: { naam: string; content?: TutorialStep }) {
  return (
    <div className="flex flex-col items-center text-center pt-8">
      ...
      <p className="text-base text-muted-foreground" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(content?.tip || 'Je kunt deze uitleg altijd teruglezen via je <strong>Profiel</strong>. 👤') }} />
    </div>
  )
}
