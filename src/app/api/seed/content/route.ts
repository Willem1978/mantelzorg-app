...
export async function POST(request: Request) {
  ...
  try {
    ...
    const catMantelzorger = [
      ...
      { slug: "emotionele-steun", naam: "Praten, steun & lotgenoten", icon: "\u{1F49A}", hint: "Praten, steun & lotgenoten", volgorde: 3 },
      { slug: "leren-en-training", naam: "Leren & training", icon: "\u{1F393}", hint: "Leren & training", volgorde: 4 },
    ]
