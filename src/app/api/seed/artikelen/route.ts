...
export async function POST(request: Request) {
  ...
  try {
    ...
    const artikelenData = [
      ...
      { id: "zz-3", titel: "Vervangende mantelzorg: even vrij van zorgen", beschrijving: "Geef de zorg tijdelijk aan iemand anders. Dat heet vervangende mantelzorg. Denk aan dagopvang, een logeerhuis of een vrijwilliger aan huis. Zo heb jij even rust.", url: "https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/", bron: "MantelzorgNL", emoji: "\u{1F33F}", categorie: "zelfzorg", subHoofdstuk: "pauze-en-respijt", bronLabel: "Gemeente (Wmo)", sorteerVolgorde: 4 },
      ...
      { id: "re-6", titel: "Recht op vervangende mantelzorg", beschrijving: "Je hebt recht op tijdelijke vervanging van de zorg. Dit kan via de Wmo, de Wlz of je zorgverzekeraar. De eigen bijdrage is maximaal 21 euro per maand.", url: "https://www.mantelzorg.nl/onderwerpen/vervangende-zorg/wie-betaalt-voor-respijtzorg/", bron: "MantelzorgNL", emoji: "\u{1F504}", categorie: "rechten", subHoofdstuk: "routekaart-wmo-zvw-wlz", bronLabel: "Landelijk", sorteerVolgorde: 4 },
    ...
    const gemeenteNieuwsData = [
      ...
      { id: "gn-arnhem-2", titel: "Vervangende mantelzorg aanvragen in Arnhem vereenvoudigd", beschrijving: "De gemeente Arnhem heeft het aanvragen van vervangende mantelzorg makkelijker gemaakt. Via het online formulier kun je nu binnen 5 werkdagen een antwoord verwachten.", gemeente: "Arnhem", datum: "2026-01-28", url: "https://www.arnhem.nl", emoji: "\u{1F4DD}" },
    ...
    const resources = [
      ...
      { title: "Vervangende mantelzorg", description: "Tijdelijke overname van zorgtaken zodat je even op adem kunt komen", content: "Vervangende mantelzorg is een vorm van zorg waarbij je zorgtaken tijdelijk worden overgenomen.", type: "ARTICLE" as const, category: "Vervangende mantelzorg", isNational: true },
