...
export async function POST() {
  ...
  try {
    const contentDefaults: Array<{
      ...
      // Hulp-tips per taak
      { categorie: "rapport", sleutel: "rapport.hulpTip.t1", waarde: "Vraag bij je gemeente naar vrijwillige hulp bij administratie en formulieren.", label: "Hulptip: Administratie", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t2", waarde: "Een casemanager of mantelzorgconsulent kan helpen met het organiseren van de zorg.", label: "Hulptip: Plannen & organiseren", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t3", waarde: "Laat boodschappen bezorgen of vraag hulp van vrijwilligers via de gemeente.", label: "Hulptip: Boodschappen", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t4", waarde: "Dagbesteding of vrijwilligers kunnen voor gezelschap en activiteiten zorgen.", label: "Hulptip: Sociaal contact", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t5", waarde: "De gemeente kan aangepast vervoer regelen (Regiotaxi, Wmo-vervoer).", label: "Hulptip: Vervoer", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t6", waarde: "Thuiszorg kan helpen met wassen, aankleden en andere persoonlijke verzorging.", label: "Hulptip: Persoonlijke verzorging", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t7", waarde: "Maaltijdservice kan kant-en-klare maaltijden bezorgen. Dat scheelt tijd en energie.", label: "Hulptip: Maaltijden", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t8", waarde: "Huishoudelijke hulp kun je aanvragen via de Wmo van je gemeente.", label: "Hulptip: Huishoudelijke taken", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t9", waarde: "Vrijwilligers of een klussenbus kunnen helpen met klussen in huis.", label: "Hulptip: Klusjes", type: "textarea", groep: "Hulp-tips" },
      { categorie: "rapport", sleutel: "rapport.hulpTip.t10", waarde: "Vraag bij je gemeente of buren naar hulp bij het uitlaten of verzorgen van huisdieren.", label: "Hulptip: Huisdieren", type: "textarea", groep: "Hulp-tips" },
